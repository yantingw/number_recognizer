...
var app = new Vue({
    ...
    methods:{
        ...
        submit: function(){
            ...
            var THE_TRUE_ANS = prompt('Please enter your answer.');
            
            while (THE_TRUE_ANS == null || THE_TRUE_ANS.length==0)  // || re.match(r' ',THE_TRUE_ANS))
                {
                    THE_TRUE_ANS = prompt('GIVE ME A ANSWER .\\ ^ /.');
                }
